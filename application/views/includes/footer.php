...
<!-- Morris.js charts
<script src="<?php //echo base_url().'assets/js/bower_components/raphael/raphael.min.js'?>"></script>
<script src="<?php //echo base_url().'assets/js/bower_components/morris.js/morris.min.js'?>"></script> -->
<!-- Sparkline -->
...
<!---<script src="<?php //echo base_url().'assets/js/dist/js/pages/dashboard.js'?>"></script>-->
