  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> ViewAppointments</li>
      </ol>
    </section>
...
-->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  {?>
                  <td>
                    <?=$Appointment['Appointment_patient_name'] ?>
                  </td>
                  <?php 
                  }
                  else
                  {
                    ?>
                    <td>
                    <?=$Appointment['Appointment_doctor_name'] ?>
                    </td>
                    <?php 
                  }
                  ?>
                  ...
                  <td>
                    <?=$Formated_appointment_date ?>
                  </td>
                  <td><?=$Formated_appointment_Time?></td>
                  ...
                  { 
                    ...
                    {
                      ?>
                      <a href="<?php echo base_url().'Appointment/AppointmentPrescription/'.$Appointment['appointment_id']; ?> " target="_blank"  class="btn  btn-warning btn-sm">process</a>
                      <!--<button type="button" class="btn  btn-warning btn-sm">Warning</button>-->
                  
                  <?php 
                    }
                    if($Appointment['appointment_status_id'] == 13)
                    {
                  ?>
                  <button type="button" class="btn  btn-success btn-sm" onclick="funChangeAppointmentStatus(<?=$Appointment['appointment_id']?>,<?=$Appointment['appointment_status_id'] ?> , CancelAppointment=0)" >Approve</button>
...
<script>
  ...
  function funChangeAppointmentStatus(appointment_id , appointment_status_id , CancelAppointment)
  {
    var msgConfirm="";
      ...
      {
        msgConfirm = "Are you sure you want to cancel this Appointment?";
      }
      else
      {
        msgConfirm = "Are you sure you want to approve this Appointment?";
      }
